...
export function EditCampaign() {
  ...
  const initialData = {
    ...
    schedule: {
      ...
      event: {
        source: 'app' as const,
        triggerMethod: 'event' as const,
        eventName: '',
        match: 'every' as const,
        nthOccurrence: 2,
        delayMinutes: 0,
        dedupeWindowValue: 30,
        dedupeWindowUnit: 'seconds' as const,
        timezone: 'Asia/Kolkata' as const,
        daysOfWeek: ['mon', 'tue', 'wed', 'thu', 'fri'] as Array<
          'mon' | 'tue' | 'wed' | 'thu' | 'fri' | 'sat' | 'sun'
        >,
        windowStart: '09:00',
        windowEnd: '20:00',
        frequencyCap: 'cooldown' as const,
        cooldownHours: 24,
        maxEntriesPerUser: null,
        allowReentry: true,
        endDate: '',
        webhook: { authMethod: 'bearer' as const, bearerToken: '', hmacSecret: '' },
      },
      startDate: '',
      startTime: '10:00',
      endDate: '',
      endTime: '19:00',
      smartGoalFocus: 'start_ai' as const,
    },
    voiceConfig: {},
    highIntent: {
      enabled: false,
